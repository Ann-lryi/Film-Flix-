...
object FilmFlixIcons {
    ...
    val PlayFilled: ImageVector by lazy {
        ImageVector.Builder(
            ...
            path(
                ...
                moveTo(8.0f, 5.14f)
                curveTo(7.4f, 4.78f, 6.6f, 5.21f, 6.6f, 5.91f)
                lineTo(6.6f, 18.09f)
                curveTo(6.6f, 18.79f, 7.4f, 19.22f, 8.0f, 18.86f)
                lineTo(17.62f, 12.77f)
                curveTo(18.16f, 12.43f, 18.16f, 11.57f, 17.62f, 11.23f)
                close()
            }
        }.build()
    }
    ...
    val StarFilled: ImageVector by lazy {
        ImageVector.Builder(
            ...
            path(
                ...
                lineTo(14.6f, 8.62f)
                lineTo(21.1f, 9.27f)
                curveTo(21.65f, 9.32f, 21.88f, 9.99f, 21.48f, 10.36f)
                lineTo(16.66f, 14.84f)
                lineTo(18.09f, 21.21f)
                curveTo(18.22f, 21.75f, 17.65f, 22.17f, 17.17f, 21.89f)
                lineTo(12f, 18.66f)
                lineTo(6.83f, 21.89f)
                curveTo(6.35f, 22.17f, 5.78f, 21.75f, 5.91f, 21.21f)
                lineTo(7.34f, 14.84f)
                lineTo(2.52f, 10.36f)
                curveTo(2.12f, 9.99f, 2.35f, 9.32f, 2.9f, 9.27f)
                lineTo(9.4f, 8.62f)
                close()
            }
        }.build()
    ...
    val HeartFilled: ImageVector by lazy {
        ImageVector.Builder(
            ...
            path(
                ...
                curveTo(5.4f, 15.0f, 2.0f, 12.0f, 2.0f, 8.5f)
                curveTo(2.0f, 5.42f, 4.42f, 3.0f, 7.0f, 3.0f)
                curveTo(8.6f, 3.0f, 10.2f, 3.79f, 12f, 5.27f)
                curveTo(13.8f, 3.79f, 15.4f, 3.0f, 17f, 3.0f)
                curveTo(19.58f, 3.0f, 22f, 5.42f, 22f, 8.5f)
                curveTo(22f, 12.0f, 18.6f, 15.0f, 13.45f, 19.69f)
                close()
            }
        }.build()
    }
    ...
    /** Hai thanh dừng bo góc — đồng bộ phong cách với PlayFilled (taper nhẹ, EvenOdd). */
    val PauseFilled: ImageVector by lazy {
        ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black), pathFillType = PathFillType.EvenOdd) {
                // Thanh trái
                moveTo(6.2f, 5.0f)
                arcTo(1.8f, 1.8f, 0f, false, false, 4.4f, 6.8f)
                lineTo(4.4f, 17.2f)
                arcTo(1.8f, 1.8f, 0f, false, false, 6.2f, 19.0f)
                arcTo(1.8f, 1.8f, 0f, false, false, 8.0f, 17.2f)
                lineTo(8.0f, 6.8f)
                arcTo(1.8f, 1.8f, 0f, false, false, 6.2f, 5.0f)
                close()
                // Thanh phải
                moveTo(17.8f, 5.0f)
                arcTo(1.8f, 1.8f, 0f, false, false, 16.0f, 6.8f)
                lineTo(16.0f, 17.2f)
                arcTo(1.8f, 1.8f, 0f, false, false, 17.8f, 19.0f)
                arcTo(1.8f, 1.8f, 0f, false, false, 19.6f, 17.2f)
                lineTo(19.6f, 6.8f)
                arcTo(1.8f, 1.8f, 0f, false, false, 17.8f, 5.0f)
                close()
            }
        }.build()
    }
    ...
    /**
     * Mũi tên vòng cung — dùng cho tua lùi/tiến. Component gọi icon này tự thêm nhãn số giây
     * ("10") đè lên giữa, và lật ngang (scaleX = -1) để tạo phiên bản tua tiến từ cùng 1 path.
     */
    val ReplayOutline: ImageVector by lazy {
        outlineIcon("ReplayOutline") {
            // Cung tròn ~290° mở về phía dưới-phải, nơi mũi tên chỉ vào
            moveTo(19.5f, 12.0f)
            arcTo(7.5f, 7.5f, 0f, true, true, 15.8f, 5.6f)
            // Mũi tên tại đầu mút cung
            moveTo(12.2f, 3.6f)
            lineTo(16.1f, 5.4f)
            lineTo(13.9f, 8.9f)
        }
