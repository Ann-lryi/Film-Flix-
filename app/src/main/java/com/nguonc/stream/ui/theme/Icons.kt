    ...
    val PlayFilled: ImageVector by lazy {
        ImageVector.Builder(
            ...
            path(
                ...
                moveTo(8.0f, 5.14f)
                cubic(7.4f, 4.78f, 6.6f, 5.21f, 6.6f, 5.91f)
                lineTo(6.6f, 18.09f)
                cubic(6.6f, 18.79f, 7.4f, 19.22f, 8.0f, 18.86f)
                lineTo(17.62f, 12.77f)
                cubic(18.16f, 12.43f, 18.16f, 11.57f, 17.62f, 11.23f)
                close()
            }
        }.build()
    }
    ...
    val StarFilled: ImageVector by lazy {
        ImageVector.Builder(
            ...
            path(
                ...
                lineTo(14.6f, 8.62f)
                lineTo(21.1f, 9.27f)
                cubic(21.65f, 9.32f, 21.88f, 9.99f, 21.48f, 10.36f)
                lineTo(16.66f, 14.84f)
                lineTo(18.09f, 21.21f)
                cubic(18.22f, 21.75f, 17.65f, 22.17f, 17.17f, 21.89f)
                lineTo(12f, 18.66f)
                lineTo(6.83f, 21.89f)
                cubic(6.35f, 22.17f, 5.78f, 21.75f, 5.91f, 21.21f)
                lineTo(7.34f, 14.84f)
                lineTo(2.52f, 10.36f)
                cubic(2.12f, 9.99f, 2.35f, 9.32f, 2.9f, 9.27f)
                lineTo(9.4f, 8.62f)
                close()
            }
        }.build()
    ...
    val HeartFilled: ImageVector by lazy {
        ImageVector.Builder(
            ...
            path(
                ...
                cubic(5.4f, 15.0f, 2.0f, 12.0f, 2.0f, 8.5f)
                cubic(2.0f, 5.42f, 4.42f, 3.0f, 7.0f, 3.0f)
                cubic(8.6f, 3.0f, 10.2f, 3.79f, 12f, 5.27f)
                cubic(13.8f, 3.79f, 15.4f, 3.0f, 17f, 3.0f)
                cubic(19.58f, 3.0f, 22f, 5.42f, 22f, 8.5f)
                cubic(22f, 12.0f, 18.6f, 15.0f, 13.45f, 19.69f)
                close()
            }
        }.build()
    }
